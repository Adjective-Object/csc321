...
x = tf.placeholder(tf.float32, [1, 277, 277, 3])
...
snapshot = None # "new_snapshot_pass_0001.pkl" # None
if snapshot:
...
lam = 0.00000
decay_penalty =lam*tf.reduce_sum(tf.square(outW))
NLL = -tf.reduce_sum(y*tf.log(out)+decay_penalty)
